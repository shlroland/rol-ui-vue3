...
import { Checkbox as RolCheckbox, CheckboxButton as RolCheckboxButton, CheckboxGroup as RolCheckboxGroup } from '@rol-ui/checkbox';
...
import { Dropdown as RolDropdown, DropdownItem as RolDropdownItem, DropdownMenu as RolDropdownMenu } from '@rol-ui/dropdown';
...
import { Container as RolContainer, Aside as RolAside, Footer as RolFooter, Header as RolHeader, Main as RolMain } from '@rol-ui/layout';
import RolLoading, { LoadingIns as RolLoadingWrap } from '@rol-ui/loading';
import { Menu as RolMenu, MenuGroup as RolMenuGroup, MenuItem as RolMenuItem, Submenu as RolSubmenu } from '@rol-ui/menu';
...
import { Select as RolSelect, SelectOption as RolSelectOption, SelectOptionGroup as RolSelectOptionGroup } from '@rol-ui/select';
...
declare const install: (app: App, option: InstallOptions) => void;
export { RolAlert, RolAvatar, RolBadge, RolBreadcrumb, RolBreadcrumbItem, RolButton, RolButtonGroup, RolCard, RolCarousel, RolCarouselItem, RolCheckbox, RolCheckboxButton, RolCheckboxGroup, RolCollapse, RolCollapseItem, RolCollapseTransition, RolDatePicker, RolDivider, RolDropdown, RolDropdownItem, RolDropdownMenu, RolRow, RolCol, RolIcon, RolImage, RolInput, RolContainer, RolAside, RolFooter, RolHeader, RolMain, RolLoadingWrap, RolMenu, RolMenuGroup, RolMenuItem, RolSubmenu, RolMessageBoxWrap, RolMessageWrap, RolModal, RolNotifyWrap, RolPageHeader, RolPagination, RolPopconfirm, RolPopover, RolPopper, RolProgress, RolRadio, RolRadioGroup, RadioButton, RolScrollBar, RolSelect, RolSelectOption, RolSelectOptionGroup, RolSwitch, RolTabs, RolTabsNav, RolTabPane, RolTag, RolTags, RolTagsAddons, RolTimePicker, RolTooltip, RolUpload, RolLoading, RolMessageBox, RolMessage, RolNotification, install, };
