---
title: Pagination
description: Pagination component doc
...
<template>
  ...
  <div class="block">
    ...
    <rol-pagination layout="prev, pager, next" :total="1000"> </rol-pagination>
  </div>
</template>
```
...
```vue demo
<template>
  <rol-pagination :page-size="20" :pager-count="11" layout="prev, pager, next" :total="1000"> </rol-pagination>
</template>
```
...
```vue demo
<template>
  <rol-pagination background layout="prev, pager, next" :total="1000"> </rol-pagination>
</template>
```
...
```vue demo
<template>
  <rol-pagination small layout="prev, pager, next" :total="50"> </rol-pagination>
</template>
```
...
```vue demo
<template>
  <rol-switch v-model="value"> </rol-switch>
  <rol-pagination :hide-on-single-page="value" :total="5" layout="prev, pager, next"> </rol-pagination>
</template>
